            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 centered">
                        ...
                        <h4><img src="images/contactos.jpg"></h4>
                        <p>Dirección: <%out.print(direccion);%></p>
                        <p> E-mail: <%out.print(correoi);%></p>
                        <p>Teléfonos: <%out.print(telefonoi);%></p>
                        <p> Celulares: <%out.print(celulari);%></p>
                        <p> Horario de Atención: <%out.print(horario);%></p>
