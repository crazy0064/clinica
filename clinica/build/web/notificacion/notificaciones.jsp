        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper">
                    <br>
                    <center><h4><i class="fa fa-plus"></i>Notas Personales</h4></center>
                    <div class="row mt">

                        <div class="col-lg-12">
                            <div class="form-panel">

                                <form  id="notificaciones" name="notificaciones" action="notificaciones.jsp" method="POST">
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tbuscar" id="tbuscar">
                                            <option value="0">Notas Actuales</option>
                                            <option value="1">Busqueda por Asunto</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from notas where idpersona='" + idno + "' order by idnota desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select * from notas where idpersona='" + idno + "' and  fecha='" + actual + "'";
                                            } else if (valor.equals("1")) {
                                                consulta = "select * from notas where idpersona='" + idno + "' and asunto like'%" + buscar + "%'";
                                            }
                                        }
                                        ...
                                        out.print("    <th><i class='fa fa-list-alt'></i> Asunto</th>");
                                        out.print("    <th class='hidden-phone'><i class='fa fa-list'></i>Tipo de Fecha</th>");
                                        out.print(" <th><i class='fa fa-check-square-o'></i> Visto </th>");
                                        out.print(" <th class='hidden-phone'><i class='fa fa-check-square-o'></i> Estado Nota</th>");
                                        ...
                                        while (rs.next()) {
                                            out.print("   <tr>");
                                            out.print("  <td  class='hidden-phone'>" + rs.getString("idnota") + "</td>");
                                            out.print("    <td>" + rs.getString("asunto") + "</td>");
                                            out.print("    <td class='hidden-phone'>" + rs.getString("fecha") + "</td>");
                                            if (rs.getString("estvisto").equals("f")) {
                                                out.print("   <td>No Visto</td>");

                                            } else {
                                                out.print("   <td>Visto</td>");

                                            }
                                            if (rs.getString("estnota").equals("t")) {
                                                out.print("   <td  class='hidden-phone'><span class='label label-info label-mini'>Activo</span></td>");

                                            } else {
                                                out.print("   <td  class='hidden-phone'><span class='label label-info label-mini'>Desactivado</span></td>");

                                            }
                                            out.print("    <td>");
                                            out.print("  <a href = '../notificacion/nota.jsp?id=" + rs.getString("idnota") + "' <button class='btn btn-primary btn-xs'><i class='fa fa-eye'></i></button> </a>");
                                            out.print("  <a href = '../procesos/anota.jsp?id=" + rs.getString("idnota") + "' <button class='btn btn-success btn-xs'><i class='fa fa-play'></i></button></a>");
                                            out.print("   <a href = '../procesos/dnota.jsp?id=" + rs.getString("idnota") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-stop'></i></button></a>");
                                            out.print("   <a href = '../procesos/enota.jsp?id=" + rs.getString("idnota") + "' <button class='btn btn-danger btn-xs'><i class='fa fa-eraser'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
