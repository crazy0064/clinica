                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        ResultSet rs1 = con.consulta("select * from noticias where id_noticia='" + id + "'");
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody> <tr>
                                                <td ><h4 align="center"><% out.print(titulo);%></h4></td>
                                            </tr>
                                            <tr><td></td></tr>
                                            <tr>
                                                <td ><p>Fecha: <% out.print(fecha);%></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
                                                <td >
                                        <center><img src="..<% out.print(imagen);%>" width="100%" height="100%" alt=""/>	   </center>
                                        </td>
                                        </tr></tbody>
                                    </table>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody> 
                                            <tr>
                                                <td ><p align="justify"><% out.print(encabezado);%></p></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
                                                <td ><p align="justify"><% out.print(cuerpo);%></p></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
                                                <td ><p >Autor: <% out.print(autor);%></p></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td ><p >Fuente: <% out.print(fuente);%></p></td>
                                            </tr>
                                        </tbody>
                                    </table>  
                                    <br>
