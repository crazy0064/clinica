                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form  id="noticias" name="noticias" action="noticias.jsp" method="POST">
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tbuscar" id="tbuscar">
                                            <option value="0">Noticias Actuales</option>
                                            <option value="1">Busqueda por Tema</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from noticias  order by id_noticia desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select * from noticias where  fecha='" + actual + "'";
                                            } else if (valor.equals("1")) {
                                                consulta = "select * from noticias where  encabezado like'%" + buscar + "%'";
                                            }
                                        }
                                        ...
                                        out.print(" <thead>");
                                        out.print("  <tr>");
                                        out.print("    <th><i class='fa fa-barcode'></i> Imagen</th>");
                                        out.print("    <th class='hidden-phone'><i class='fa fa-list-alt'></i> Titulo</th>");
                                        out.print("    <th><i class='fa fa-list'></i>Autor</th>");;
                                        out.print("    <th class='hidden-phone'><i class='fa fa-list'></i>Estado</th>");;
                                        ...
                                        while (rs.next()) {
                                            out.print("   <tr>");
                                            out.print("  <td><img src='.." + rs.getString("imagen") + "' width='60' height='60' alt=''/></td>");
                                            out.print("    <td class='hidden-phone'>" + rs.getString("titulo") + "</td>");
                                            out.print("    <td>" + rs.getString("autor") + "</td>");
                                            if (rs.getString("estado").equals("t")) {
                                                out.print("    <td class='hidden-phone'>Activo</td>");
                                            } else {
                                                out.print("    <td class='hidden-phone'>Desactivado</td>");
                                            }
                                            out.print("    <td>");
                                            out.print("  <a href = '../notificacion/mnoticia.jsp?id=" + rs.getString("id_noticia") + "' <button class='btn btn-primary btn-xs'><i class='fa fa-eye'></i></button> </a>");
                                            out.print("  <a href = '../procesos/anoticia.jsp?id=" + rs.getString("id_noticia") + "' <button class='btn btn-success btn-xs'><i class='fa fa-play'></i></button></a>");
                                            out.print("   <a href = '../procesos/dnoticia.jsp?id=" + rs.getString("id_noticia") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-stop'></i></button></a>");
                                            out.print("   <a href = '../procesos/enoticia.jsp?id=" + rs.getString("id_noticia") + "' <button class='btn btn-danger btn-xs'><i class='fa fa-eraser'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
