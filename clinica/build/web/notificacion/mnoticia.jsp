                            ...
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    <%rs = con.consulta("select * from noticias where id_noticia='" + id + "'");
                                        while (rs.next()) {%>
                                    <form id="mnoticia" name="mnoticia" action="" method="post">

                                        <div id="noti">
                                            <table width="100%">
                                                <tr>
                                                    <td><input type="text" value="<%out.print(rs.getString("titulo"));%>" minlength="33" required class="form-control" id="titulo" name="titulo" placeholder="Título de la noticia"></td>
                                                </tr>
                                            </table>
                                            <br>
                                            <table width="100%">
                                                <tr>
                                                    <td><textarea rows="7" required minlength="33" class="form-control" id="encabezado" name="encabezado" placeholder="Encabezado de la noticia"><%out.print(rs.getString("encabezado"));%></textarea></td>
                                                </tr>
                                            </table>
                                            <br>
                                            <table width="100%">
                                                <tr>
                                                    <td><textarea rows="10" required class="form-control" id="cuerpo" name="cuerpo" placeholder="Cuerpo de la noticia"><%out.print(rs.getString("cuerpo"));%></textarea></td>
                                                </tr>
                                            </table>
                                            <br>
                                            <table width="100%">
                                                <tr>
                                                    <td><input type="text" required value="<%out.print(rs.getString("autor"));%>" class="form-control" id="autor" name="autor" placeholder="Autor de la noticia"></td>
                                                </tr>
                                                <tr>
                                                    <td><input type="text" required value="<%out.print(rs.getString("fuente"));%>" class="form-control" id="fuente" name="fuente" placeholder="Fuente"></td>
                                                </tr>
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            con.consulta("update noticias set titulo='" + titulo1 + "',  fecha='" + actual + "', encabezado='" + encabezado1 + "',  cuerpo='" + cuerpo1 + "',  autor='" + autor1 + "',  fuente='" + fuente1 + "' where id_noticia='"+id+"'");
                                            out.println("<script language='javascript'>window.location='../notificacion/noticias_img.jsp?id="+id+"'</script>;");
