                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from noticias where estado='true' order by id_noticia desc limit 25";
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a href = '../notificacion/noticia.jsp?id=" + rs.getString("id_noticia") + "' <button class='btn btn-primary'><i class='fa fa-eye'></i></button> </a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
