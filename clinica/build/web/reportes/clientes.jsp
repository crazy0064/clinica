                            ...
                            <div class="form-panel">
                                ...
                                <form  id="clientes" name="clientes" action="" method="POST">
                                    <div class="form-group">
                                        <input type="text" required class="form-control" id="from" name="from" placeholder="Iniciar reporte desde" title="Seleccione la fecha anterior para generar el reporte ">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" required class="form-control" id="to" name="to" placeholder="Finalizar reporte hasta" title="Seleccione la fecha actual para generar el reporte ">
                                    </div>
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tipor" id="tipor">
                                            <option value="">Seleccione tipo de reporte</option>
                                            <option value="0">Los mejores Clientes</option>
                                            <option value="1">Los mejores medicos</option>
                                            <option value="2">Ver que consultorios estan mas ocupados</option>
                                            <option value="3">Saldos obtenidos</option>
                                        </select>
                                    </div>
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        if (tipor.equals("0")) {
                                            out.println("<script language='javascript'>window.location='../reportes/vcliente.jsp?from=" + from + "&&to=" + to + "&&tipor=pdf/cliente.jasper'</script>;");
                                        } else if (tipor.equals("1")) {
                                            out.println("<script language='javascript'>window.location='../reportes/vcliente.jsp?from=" + from + "&&to=" + to + "&&tipor=pdf/doctores.jasper'</script>;");
                                        }
                                        else if (tipor.equals("2")) {
                                            out.println("<script language='javascript'>window.location='../reportes/vcliente.jsp?from=" + from + "&&to=" + to + "&&tipor=pdf/consultorios.jasper'</script>;");
                                        }
                                        else if (tipor.equals("3")) {
                                            out.println("<script language='javascript'>window.location='../reportes/vcliente.jsp?from=" + from + "&&to=" + to + "&&tipor=pdf/saldos.jasper'</script>;");
                                        }
                                    }
                                %>
                            </div>
