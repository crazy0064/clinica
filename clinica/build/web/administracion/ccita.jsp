        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper">
                    <center><h4><i class="fa fa-refresh"></i>Actualizar estado de pago</h4></center>
                    <div class="row mt">

                        <div class="col-lg-12">
                            <div class="form-panel">
                                <br> 
                                <form action="" id="ccita" name="ccita" method="post">
                                    ...
                                    <button type="submit" class="btn btn-default btn-lg btn-block" name="confi" id="confi">Cambiar estado</button>
                                </form>
                                <%
