                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <%
                                    rs = con.consulta("select * from personas p, doctores d,especialidad e  where d.dnidoctor=p.dni and e.codesp=d.espdoctor and d.iddoctor='" + id + "'");
                                    String usuario = "";
                                    while (rs.next()) {
                                        ...
                                        out.print("   </div>");
                                        out.print("  <div class='form-group'>");
                                        out.print(" <select name='especial' required class='form-control' id='especial'>");
                                        ...
                                        while (rs1.next()) {
                                            out.print(" out.print('<option value='" + rs1.getString("codesp") + "'>" + rs1.getString("nomesp") + "</option>');");
                                        }
                                        out.print("  </select>");
                                        out.print(" </div>");
                                        out.print("  <div class='form-group'>");
                                        ...
                                        out.print("   </div>");
                                        out.print("  <button type='submit' class='btn btn-default btn-lg btn-block' id='enviar' name='enviar'>Guardar Registro</button>");
                                        out.print(" </form>");
                                    }
                                %>
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        con.consulta("UPDATE doctores SET espdoctor='" + especial + "' WHERE iddoctor='" + id + "';");
                                        out.print("<script>alert('Registro Actualizado');</script>");
                                        out.println("<script language='javascript'>window.location='../administracion/listaresp.jsp?id=" + usuario + "'</script>;");
                                    }
