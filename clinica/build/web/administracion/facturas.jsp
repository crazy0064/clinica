                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form  id="facturas" name="facturas" action="facturas.jsp" method="POST">
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tbuscar" id="tbuscar">
                                            ...
                                            <option value="3">Buscar desde codigo de factura</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from citas where paciente='" + id + "' and estpago='Pagado' order by idcita desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select * from citas where paciente='" + id + "' and estpago='Pagado' order by idcita desc";
                                            } else if (valor.equals("1")) {
                                                consulta = "select * from citas where paciente='" + id + "' and estpago='Pagado' order by idcita desc limit 25";
                                            } else if (valor.equals("2")) {
                                                consulta = "select * from citas where paciente='" + id + "' and estpago='Pagado' order by idcita asc limit 25";
                                            } else if (valor.equals("3")) {
                                                consulta = "select * from citas where paciente='" + id + "' and estpago='Pagado' and idcita='" + buscar + "'";
                                            } else {
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a href = '../reportes/vfactura.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-success btn-xs'><i class='fa fa-eye'></i></button></a>");
                                            out.print("   <a href = '../reportes/efactura.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-paper-plane'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
