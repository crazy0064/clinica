                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        rs = con.consulta("select * from especialidad where codesp='" + id + "'");
                                        while (rs.next()) {
                                            out.print(" <form  id='moespecialidad' name='moespecialidad' action='' method='POST'>");
                                            out.print(" <div class='form-group'>");
                                            out.print("     <input name='codigoe' disabled value='" + rs.getString("codesp") + "' type='text' required class='form-control' id='codigoe' placeholder='Ingrese codigo unico de Especialidad' maxlength='3'>");
                                            out.print(" </div>");
                                            out.print(" <div class='form-group'>");
                                            out.print("     <input type='text' value='" + rs.getString("nomesp") + "' required class='form-control' id='nombree' name='nombree' placeholder='Ingrese la Especialidad'>");
                                            out.print(" </div>");
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            rs = con.consulta("select count(*) from especialidad where nomesp='" + nomesp + "'");
                                            String com = "";
                                            while (rs.next()) {
                                                com = rs.getString("count");
                                            }
                                            if (com.equals("0")) {
                                                con.consulta("update especialidad set nomesp='" + nomesp + "' where codesp='" + id + "'");
                                                out.print("<script>alert('Se ha Actualizado el registro');</script>");
                                                out.println("<script language='javascript'>window.location='../administracion/listare.jsp'</script>;");
                                            } else {
                                                out.print("<script>alert('Se ha comprobado que un registro tiene el mismo nombre');</script>");
