                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form  id="listarcitasp" name="listarcitasp" action="listarcitasp.jsp" method="POST">
                                    <div class="form-group">
                                        <select autofocus required class="form-control" name="tbuscar" id="tbuscar">
                                            ...
                                            <option value="1">Citas por Dni </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        Date hoy = new Date();
                                        String consulta = "select * from citas where medico='" + id + "' order by idcita desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select * from citas where medico='" + id + "' and fecha='" + hoy + "'";
                                            } else if (valor.equals("1")) {
                                                consulta = "select * from citas where medico='" + id + "' and paciente='" + buscar + "'";
                                            } else if (valor.equals("2")) {
                                                consulta = "select * from citas where medico='" + id + "' and fecha='" + buscar + "'";
                                            } else if (valor.equals("3")) {
                                                consulta = "select * from citas where medico='" + id + "'";
                                            }
                                        }
