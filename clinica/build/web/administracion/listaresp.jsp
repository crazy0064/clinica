                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from personas p, doctores d,especialidad e  where d.dnidoctor=p.dni and e.codesp=d.espdoctor and p.dni='" + id + "'";
                                        ...
                                        out.print("    <th class='hidden-phone'><i class='fa fa-list-alt'></i>Doctor</th>");
                                        ...
                                        while (rs.next()) {
                                            ...
                                            if (rs.getString("estdoctor").equals("t")) {
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a href = '../administracion/mregistroe.jsp?id=" + rs.getString("iddoctor") + "' <button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a>");
                                            out.print("  <a href = '../procesos/aespe.jsp?id=" + rs.getString("iddoctor") + "&&idc=" + id + "' <button class='btn btn-success btn-xs'><i class='fa fa-play'></i></button></a>");
                                            out.print("   <a href = '../procesos/eespe.jsp?id=" + rs.getString("iddoctor") + "&&idc=" + id + "' <button class='btn btn-warning btn-xs'><i class='fa fa-stop'></i></button></a>");
                                            out.print("   <a href = '../procesos/elespe.jsp?id=" + rs.getString("iddoctor") + "&&idc=" + id + "' <button class='btn btn-danger btn-xs'><i class='fa fa-eraser'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
                                ...
                                <br>
                                <form  id="listaresp" name="listaresp" action="nespecialista.jsp?id=<%out.print(id);%>" method="POST">

                                    <button type="submit" class="btn btn-default btn-lg btn-block" id="buscar" name="buscar">Agregar Nueva Especialidad</button>
                                </form>
                                <br>
                                <form  id="listaresp" name="listaresp" action="horariom.jsp?id=<%out.print(id);%>" method="POST">

                                    <button type="submit" class="btn btn-default btn-lg btn-block" id="buscar" name="buscar">Ver horario</button>
                                </form>
                                <form  id="listaresp" name="listaresp" action="" method="POST">

                                    <button type="submit" class="btn btn-default btn-lg btn-block" id="gcita" name="gcita">Generador de citas</button>
                                </form>
                                <%
                                    if (request.getParameter("gcita") != null) {
                                        out.println("<script language='javascript'>window.location='../administracion/ncitasm.jsp?id=" + id + "'</script>;");
                                    }
                                %>
                            </div>
                        </div>
