                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <br> <br>
                                <form  id="ncitas" name="ncitas" action="ncitas.jsp" method="POST">

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="busqueda" name="busqueda" placeholder="Busqueda avanzada ........." title="Busqueda avanzada ........." onClick="abrirc('../busquedas/datos');">
                                    ...
                                    <%
                                        if (request.getParameter("buscar") != null) {
                                            ...
                                            if (!conte.equals("0")) {
                                                ...
                                                out.print("       <th>Jueves <input  type='text' size='1' name='diaj' value=" + (diaj.substring(8, 10)) + "></th>");
                                                out.print("       <th>Viernes <input  type='text' size='1' name='diav' value=" + (diav.substring(8, 10)) + "></th>");
                                                out.print("       <th>Sabado <input  type='text' size='1' name='dias' value=" + (dias.substring(8, 10)) + "></th>");
                                                out.print("       <th>Domingo <input  type='text' size='1' name='diad' value=" + (diad.substring(8, 10)) + "></th>");
                                                out.print("    </tr>");
                                                ...
                                                while (rs.next()) {
                                                    ...
                                                    if (rs.getString("lunes").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + dia + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");

                                                    } else {
                                                        out.print("<td><a style='color:#FF0004'>Ocupado</a></td>");
                                                    }
                                                    if (rs.getString("martes").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diam + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");
                                                    ...
                                                    if (rs.getString("miercoles").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diami + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");
                                                    ...
                                                    if (rs.getString("jueves").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diaj + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");
                                                    ...
                                                    if (rs.getString("viernes").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diav + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");
                                                    ...
                                                    if (rs.getString("sabado").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + dias + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");
                                                    ...
                                                    if (rs.getString("domingo").equals("t")) {
                                                        out.print("<td><a style='color:#1AC87F' href='ncita.jsp?hora=" + rs.getString("horahor") + "&&fecha=" + diad + "&&idd=" + id + "&&idp=" + idp + "&&idc=" + idc + "'>Agregar Cita</a></td>");
                                ...
                                <br>
                                <form id="dar" name="dar" method="post" action="ncitas.jsp">
