                    ...
                    <div class="form-panel">
                        ...
                        <div class="form-group">
                            ...
                            <%                                if (request.getParameter("buscar") != null) {
                                    ...
                                    String consulta = "";
                                    consulta = "select d.*, e.*,p.* from doctores d,especialidad e,personas p where p.dni=d.dnidoctor and codesp=espdoctor and estdoctor='true' and estesp='true' and  codesp='" + valor + "' or dnidoctor='" + buscar + "'";
