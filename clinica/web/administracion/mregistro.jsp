                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <% if (request.getParameter("enviar") != null) {
                                        ...
                                        con.consulta("UPDATE personas SET nombres='" + nombre + "', apellidos='" + apellido + "', telefono='" + telefono + "',celular='" + celular + "', direccion='" + direccion + "', tpersona='" + perfil + "', fnacimiento='" + fecha + "', sexo='" + sexo + "' WHERE dni='" + id + "';");
