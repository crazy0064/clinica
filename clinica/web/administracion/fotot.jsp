...
<%
    ...
    ResultSet rs = null;
    String nom = "", apel = "", foto = "", id = "", pri = "", idno = "", fotot = "";//variables de usuario
        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper">
                    <center><h4><i class="fa fa-refresh"></i>Modificando Registro de vaucher</h4></center>
                    <div class="row mt">

                        <div class="col-lg-12">
                            <div class="form-panel">
                                <br>
                                <div style=" text-align:center"><img src="..<% out.print(fotot);%>" width="250" height="250" alt=""/></div>
                                <br>
                                <form  action="../procesos/subirp.jsp?id=<%out.print(id);%>" enctype="multipart/form-data" method="post">

                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Baucher de cancelacion</label>
                                        <div class="col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-default btn-lg btn-block">Enviar Para confirmacion</button>
                                </form>
                                <br>
                            </div>
                        </div>  
