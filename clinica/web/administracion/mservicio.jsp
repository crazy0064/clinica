                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        rs = con.consulta("select * from servicios where idservicio='" + id + "'");
                                        while (rs.next()) {
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            rs = con.consulta("select count(*) from servicios where nomservicio='" + nomesp + "'");
                                            String com = "";
                                            while (rs.next()) {
                                                com = rs.getString("count");
                                            }
                                            if (com.equals("0")) {
                                                con.consulta("update servicios set nomservicio='" + nomesp + "' where idservicio='" + id + "'");
                                                out.print("<script>alert('Se ha Actualizado el registro');</script>");
                                                out.println("<script language='javascript'>window.location='../administracion/listarser.jsp'</script>;");
                                            } else {
