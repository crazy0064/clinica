                            ...
                            <div class="form-panel">
                                <form  id="listarmen" name="listarmen" action="listarmen.jsp" method="POST">
                                    <div class="form-group">
                                        <input type="text" required class="form-control" id="codigomen" name="codigomen" placeholder="Ingrese el codigo unico del menu principal" title="Ingrese el codigo unico del menu principal">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" required class="form-control" id="nombremen" name="nombremen" placeholder="Ingrese el nombre del menu principal" title="Ingrese el nombre del menu principal">
                                    </div>
                                    <div class="form-group">
                                        <input name="referencia" type="text"  class="form-control" id="referencia" placeholder="Ingrese la url de referencia al menú" title="Ingrese la url de referencia al menú">
                                    </div>
                                    <div class="form-group">
                                        <input name="clasemen" type="text"  class="form-control" id="clasemen" placeholder="Ingrese codigo de clase para generar un icono html5" title="Ingrese codigo de clase para generar un icono html5">
                                    </div>
                                    <div class="form-group">
