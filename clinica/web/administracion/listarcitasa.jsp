                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form  id="listarcitasa" name="listarcitasa" action="listarcitasa.jsp" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        Date hoy = new Date();
                                        String consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estcita='Pendiente'  order by idcita desc limit 50";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (valor.equals("0")) {
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estcita='Pendiente'  and fecha='" + hoy + "' order by idcita desc limit 50";
                                            } else if (valor.equals("1")) {
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad  and paciente='" + buscar + "' order by idcita desc limit 50";
                                            } else if (valor.equals("2")) {
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estcita='Pendiente' and fecha='" + buscar + "' order by idcita desc limit 50";
                                            } else if (valor.equals("3")) {
                                                consulta = "select * from citas,especialidad where especialidad.codesp=citas.especialidad and estcita='Pendiente' order by idcita desc limit 50";
                                            }
                                        }
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.print("    <td>");
                                            out.print("   <a title='Ver Vaicher de Pago' href = '../administracion/fotot.jsp?id=" + rs.getString("idcita") + "'<button class='btn btn-warning btn-xs'><i class='fa fa-upload'></i></button></a>");
                                            out.print("   <a title='Cambiar a Estado Pago' href = '../administracion/ccita.jsp?id=" + rs.getString("idcita") + "'<button class='btn btn-danger btn-xs'><i class='fa fa-refresh'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
