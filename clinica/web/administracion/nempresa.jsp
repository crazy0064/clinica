                            ...
                            <div class="form-panel">
                                <form  id="nempresa" name="nempresa" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="<%out.print(rs.getString("nombre"));%>" required class="form-control" id="empresa" name="empresa" placeholder="Ingrese nombre de la empresa" title="Ingrese nombre de la empresa" onkeydown="return numeros(event)" onchange="evaluar(registro)">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="<%out.print(rs.getString("telefonoi"));%>" required class="form-control" id="telefono" name="telefono" placeholder="Ingrese el telefono institucional" title="Ingrese el telefono institucional" onchange="validare(registro);">
                                    </div>
                                    <div class="form-group">
                                        <input name="direccion" value="<%out.print(rs.getString("direccion"));%>" required type="text" class="form-control" id="direccion" placeholder="Ingrese la direccion de la institucion" title="Ingrese la direccion de la institucion" onkeydown="return numeros(event)" maxlength="15">
                                    </div>
                                    <div class="form-group">
                                        <input name="celular" value="<%out.print(rs.getString("celulari"));%>" required type="text" class="form-control" id="celular" placeholder="Ingrese el celular institucional" title="Ingrese el celular institucional" onkeydown="return numeros(event)" maxlength="15">
                                    </div>
                                    <div class="form-group">
                                ...
                                <%if (request.getParameter("enviar") != null) {
                                        ...
                                        con.consulta("UPDATE empresa   SET  nombre='" + nombre + "', logo='" + logo + "', correoi='" + correo + "', telefonoi='" + telefono + "', direccion='" + direccion + "', celulari='" + celular + "', horarioa='" + horario + "', clavecor='" + clave + "' WHERE id='" + id + "';");
                                        out.print("<script>alert('Actualizacion correcta');</script>");
                                        out.println("<script language='javascript'>window.location='../administracion/nempresa.jsp'</script>;");
