                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <form id="ncita" name="ncita" action="horariom.jsp?id=<%out.print(id);%>" method="POST">
                                    ...
                                    <%    if (request.getParameter("actualiza") != null) {
                                            ...
                                            out.println("<script language='javascript'>window.location='../administracion/horariom.jsp?id=" + id + "'</script>;");
