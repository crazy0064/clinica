                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        String consulta = "select * from citas where paciente='" + id + "' order by idcita desc limit 25";
                                        if (request.getParameter("buscar") != null) {
                                            String valor = request.getParameter("tbuscar");
                                            String buscar = request.getParameter("busqueda");
                                            if (buscar.equals("")) {
                                                if (valor.equals("0")) {
                                                    consulta = "select * from citas where paciente='" + id + "' and estcita='Pagada'";
                                                } else if (valor.equals("1")) {
                                                    consulta = "select * from citas where paciente='" + id + "' and estcita='Pendiente'";
                                                } else if (valor.equals("2")) {
                                                    consulta = "select * from citas where paciente='" + id + "' and estcita='Cancelado'";
                                                } else if (valor.equals("3")) {
                                                    consulta = "select * from citas where paciente='" + id + "'";
                                                }
                                            } else {
                                                if (valor.equals("0")) {
                                                    consulta = "select * from citas where paciente='" + id + "' and estcita='Pagada' and fecha='" + buscar + "'";
                                                } else if (valor.equals("1")) {
                                                    consulta = "select * from citas where paciente='" + id + "' and estcita='Pendiente' and fecha='" + buscar + "'";

                                                } else if (valor.equals("2")) {
                                                    consulta = "select * from citas where paciente='" + id + "' and estcita='Cancelado' and fecha='" + buscar + "'";

                                                } else if (valor.equals("3")) {
                                                    consulta = "select * from citas where paciente='" + id + "'  and fecha='" + buscar + "'";
                                        ...
                                        while (rs.next()) {
                                            out.print("   <tr>");
                                            out.print("  <td class='hidden-phone'>" + rs.getString("idcita") + "</td>");
                                            out.print("    <td >" + rs.getString("asunto") + "</td>");
                                            out.print("    <td >" + rs.getString("especialidad") + "</td>");
                                            ...
                                            out.print("    <td>");
                                            out.print("  <a href = '../procesos/acita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-success btn-xs'><i class='fa fa-play'></i></button></a>");
                                            out.print("   <a href = '../procesos/bcita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-stop'></i></button></a>");
                                            out.print("   <a href = '../procesos/ecita.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-danger btn-xs'><i class='fa fa-eraser'></i></button></a>");
                                            out.print("   <a href = 'fotot.jsp?id=" + rs.getString("idcita") + "' <button class='btn btn-warning btn-xs'><i class='fa fa-upload'></i></button></a>");
                                            out.print("   </td>");
                                            out.print(" </tr>");
                                        }
                                        out.print("  </tbody>");
