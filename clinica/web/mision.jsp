            ...
            <div class="container">
                <div class="arow">
                    <div class="col-md-12 centered">
                        <h3 style="font-family: fantasy; "><span>Misión-Visión </span></h3>
                    </div>
                    <div class="col-md-6">
                        <p style="font-size:18px; text-align:justify;"><span><strong>Misión</span></strong></p>
                        <p style="font-size:15px; text-align:justify;">Brindar servicios odontológicos integrales contribuyendo a resolver eficazmente los problemas de salud Oral de nuestros pacientes, aplicando para ello conceptos de excelencia en el servicio, eficiencia en la gestión y calidez personalizada en la atención.                          </p>
                    </div>
                    <div class="col-md-6">
                        <p style="font-size:18px; text-align:justify;"><span><strong>Visión</span></strong></p>                        
                        <p style="font-size:15px; text-align:justify;">Ser la clinica odontológica líder en la zona norte del Lima con lo más avanzado en tecnología y con especialistas que reúnan los requisitos máximos de profesionalismo y excelencia, para satisfacer al máximo las exigencias de nuestros pacientes e ir más allá de sus expectativas, deseando establecer una relación duradera con cada paciente basada en el tratamiento personalizado y orientado al detalle brindándoles nuestra experiencia a su servicio.</p>     
                    </div>
                </div>
                <div class="arow">
                    <div class="col-md-12 centered">
                        <h3 style="font-family: fantasy; "><span>Conosca Nuestra Instalaciones </span></h3>
                        <br>
                        <div id="c-carousel">
                            <div id="wrapper">
                                <div id="carousel">
