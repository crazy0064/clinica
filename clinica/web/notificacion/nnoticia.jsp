                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <div class="form-group">
                                    <form id="nnoticia" name="nnoticia" action="nnoticia.jsp" method="post">

                                        <div id="noti">
                                            <table width="100%">
                                                <tr>
                                                    <td><input type="text" minlength="33" required class="form-control" id="titulo" name="titulo" placeholder="Título de la noticia" title="Título de la noticia"></td>
                                                </tr>
                                            </table>
                                            <br>
                                            <table width="100%">
                                                <tr>
                                                    <td><textarea rows="7" required minlength="33" class="form-control" id="encabezado" name="encabezado" placeholder="Encabezado de la noticia" title="Encabezado de la noticia"></textarea></td>
                                                </tr>
                                            </table>
                                            <br>
                                            <table width="100%">
                                                <tr>
                                                    <td><textarea rows="10" required class="form-control" id="cuerpo" name="cuerpo" placeholder="Cuerpo de la noticia" title="Cuerpo de la noticia"></textarea></td>
                                                </tr>
                                            </table>
                                            <br>
                                            <table width="100%">
                                                <tr>
                                                    <td><input type="text" required class="form-control" id="autor" name="autor" placeholder="Autor de la noticia" title="Autor de la noticia"></td>
                                                </tr>
                                                <tr>
                                                    <td><input type="text" required class="form-control" id="fuente" name="fuente" placeholder="Fuente" title="Fuente"></td>
                                                </tr>

                                            </table>
                                            <br>
                                            <table width="100%">
                                                <button type="submit" class="btn btn-default btn-green" name="enviar" id="enviar">Continuar</button>    
                                            </table>
                                    ...
                                    <%
                                        if (request.getParameter("enviar") != null) {
                                            ...
                                            con.consulta("INSERT INTO noticias(titulo, fecha, encabezado, cuerpo, autor, fuente) VALUES( '" + titulo1 + "',  '" + actual + "', '" + encabezado1 + "',  '" + cuerpo1 + "',  '" + autor1 + "',  '" + fuente1 + "')");
                                            rs = con.consulta("SELECT id_noticia FROM noticias order by id_noticia desc limit 1");
                                            while (rs.next()) {
                                                 out.println("<script language='javascript'>window.location='../notificacion/noticias_img.jsp?id="+rs.getString("id_noticia")+"'</script>;");
                                            }
                                        }
