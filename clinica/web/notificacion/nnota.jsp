                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form  id="nnota" name="nnota" action="nnota.jsp" method="POST">
                                    <div class="form-group">
                                        <input type="text" required class="form-control" id="asunto" name="asunto" placeholder="Ingrese el asunto" title="Ingrese el asunto">
                                    </div>
                                    <div class="form-group">
                                        <textarea name="nota" rows="9" required class="form-control" id="nota" placeholder="Ingrese la nota que desea recordar" title="Ingrese la nota que desea recordar" ></textarea>
                                    </div>
                                ...
                                <%
                                    if (request.getParameter("enviar") != null) {
                                        ...
                                        con.consulta("INSERT INTO notas(asunto,nota,idpersona,fecha)VALUES ('" + asunto + "','" + nota + "', '" + idno + "','"+actual+"');");
