        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper">
                    <br>
                    <center><h4><i class="fa fa-plus"></i>Nota de acuerdo <%out.print(id);%></h4></center>
                    <div class="row mt">

                        <div class="col-lg-12">
                            <div class="form-panel">
                                <%
                                    con.consulta("update notas set estnota='false' ,estvisto='true' where idnota='" + id + "' and idpersona='" + idno + "'");
                                    rs = con.consulta("select * from notas where idnota='" + id + "' and idpersona='" + idno + "'");
                                    while (rs.next()) {
                                %>
                                <form  id="nota" name="nota" action="nota.jsp" method="POST">
                                    <div class="form-group">
                                        <input type="text" disabled="" class="form-control" id="asunto" value='<%out.print(rs.getString("asunto"));%>' name="asunto" placeholder="Ingrese el asunto">
                                    </div>
                                    <div class="form-group">
                                        <textarea name="nota" rows="9" disabled="" class="form-control" id="nota" placeholder="Ingrese la nota que desea recordar"><%out.print(rs.getString("nota"));%></textarea>
                                    </div>
                                </form>
                                <%}%>
