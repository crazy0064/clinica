        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 centered">
                    <h3 style="font-family: fantasy; "><span><strong>Contáctenos hoy mismo a <%out.print(empresa);%><strong></span></h3>
                                    ...
                                    <div class="container content">
                                        <div class="row">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-12 centered">
                                                        <h3 style="font-family: fantasy; "><span><strong>Contactos de la <%out.print(empresa);%><strong></span></h3>
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="container">
                                                                            <div class="row">
                                                                                <div class="col-md-12 centered">
                                                                                    <h3 style="font-family: fantasy; "><span><strong>Ubicacion de la <%out.print(empresa);%><strong></span></h3>
                                                                                                    </div>
                                                                                                    </div>
                                                                                                    </div>
                                                                                                    <!-- Contenido Inicio -->
