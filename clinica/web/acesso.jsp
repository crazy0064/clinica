        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col3">
                    <a href="./registros/rnuevop.jsp" title="Registro Nuevo" class="roundal" id="kennel"></a>
                    <h3>Paciente Nuevo</h3>
                    <p>Si eres un paciente nuevo registrate para que accedas a  nuestro servicios.</p>

                </div>
                <div class="col-md-4 col3">
                    <a href="./administracion/logina.jsp" title="Iniciar como Paciente" class="roundal" id="grooming"></a>
                    <h3>Iniciar Sesion como Paciente</h3>
                    <p>Inicia a utilizar nuestros servicos que te brindara la clinica  al tener una cuenta</p>
                </div>
                <div class="col-md-4 col3">
                    <a href="./administracion/logina.jsp" title="Iniciar como Especialista" class="roundal" id="adoption"></a>
                    <h3>Iniciar Como Especialista</h3>
                    <p>Iniciar la sesión de como especialista para que pueda administrar todas la citas de los pacientes</p>
