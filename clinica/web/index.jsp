                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="./reportes/ayuda.jsp?id=/pdf/manual_principal.pdf" title="Ayuda">Ayuda</a>
                                </li>
                                <%  }
                                %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 centered">
                        ...
                        <h4><img src="images/inicio.png"></h4>
                        <p>Queremos darle la bienvenida a nuestra web e invitarle a conocer la Clinica y descubrir los servicios odontológicos integrales que brindamos, cuidando al máximo su salud con profesionalismo, calidad, garantía y brindando las mejores facilidades de pago.
