            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 centered">
                        ...
                        <h4><img src="images/quienes.png"></h4>
                        <p>En Sonrisas y Detalles, somos un equipo de dentistas especialistas capacitados que utilizamos técnicas, materiales y equipos con Tecnología de Vanguardia. Cuidamos en todo momento la estética y la función que son de vital importancia para lograr tratamientos exitosos con calidad y durabilidad para cada uno de nuestros pacientes.</p>
                        <p> Todo esto dentro de un ambiente cálido y confortable, acompañado de una atención personalizada en todas las áreas.                          </p>
                        <p>En Sonrisas y Detalles pensando en ti te ofrecemos un moderno enfoque en estética que permite ofrecer a nuestros clientes una renovada y satisfactoria imagen.</p>
                    </div>
                </div>
            </div>
        </div>
